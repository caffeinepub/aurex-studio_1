...
export class Backend implements backendInterface {
    ...
    async deleteQuote(arg0: Time): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitQuote(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitQuote(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateQuoteStatus(arg0: Time, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateQuoteStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
